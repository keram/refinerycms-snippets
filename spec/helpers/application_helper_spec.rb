...
describe ApplicationHelper do
  ...
  before(:each) do
    ...
    Refinery::PagePartSnippet.create!(page_part_id: @part.id, snippet_id: @snippet_before.id, before_body: true)
    Refinery::PagePartSnippet.create!(page_part_id: @part.id, snippet_id: @snippet_after.id)
    @page.parts << @part
  end
